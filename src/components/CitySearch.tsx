...
const CitySearch = () => {
  ...
  const { data: locations, isLoading } = useSearchLocationQuery(search);
  ...
  return (
    <>
      <Button
        variant={"outline"}
        className="relative w-36 sm:w-48 md:w-60 lg:w-64 justify-start text-sm text-muted-foreground"
